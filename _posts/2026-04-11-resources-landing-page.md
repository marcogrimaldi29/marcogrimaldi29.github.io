...
seo:
  ...
  keywords:
    ...
    - Jekyll Resources
    - Markdown Tutorials
canonical_url: "https://marcogrimaldi29.com/resources/"
read_time: true
comments: true
share: true
related: true
...
**ℹ️ Heads-up:** For other certification-related materials and insights, take a look at the "🏅 Cert Reviews" and "📘 Study Notes" sections too.
{: .notice--info}

🗒️ On this landing page, you'll find a curated collection of useful resources across various topics. Click on the corresponding link on each resource to be redirected.

✨ These resources have been collected over time from my learning journey, work experiences, and personal interests. They include guides, documentation, tools, and more to help with learning and development.
