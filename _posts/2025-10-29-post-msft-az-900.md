...
Fast-forward to 2026, and the setup has evolved a bit. **Full exam waivers are now less frequent**, but Virtual Training Days typically offer a **50% discount** instead. Occasionally, **full vouchers still pop up** during larger events like **Microsoft Ignite** or **AI Skills Challenges**.
