---
title: '🧰 Nützliche Ressourcen: Microsoft'
date: 2025-09-26
last_modified_at: 2026-01-04
locale: de
translationKey: resources-microsoft
categories:
  - Ressourcen
tags:
  - AI
  ...
  - Security
  - Teams
excerpt: 'Kuratierte Liste zentraler Microsoft-Ressourcen — erkunde Dokumentation, Lernpfade und Werkzeuge zu Azure, Microsoft 365, Power Platform, Security und KI zur Unterstützung der beruflichen Weiterbildung und Zertifizierungsvorbereitung.'
description: 'Umfassender Hub von Microsoft-Ressourcen mit offizieller Dokumentation, Lernmaterialien und Produktivitätswerkzeugen für Azure, Microsoft 365, Power Platform, Teams, Security und KI. Ideal für IT-Fachleute, Lernende und Zertifizierungskandidaten.'
permalink: /resources/resources-microsoft/
seo:
  type: 'Article'
  keywords:
...
**⚠️ Wichtiger Hinweis:** Diese Ressourcensammlung erhebt keinen Anspruch auf Vollständigkeit. Betrachte sie als Ausgangspunkt — einen Hub, in dem nützliche Werkzeuge und Links frei zugänglich gesammelt werden. Wenn dir veraltetes Material oder Ungereimtheiten auffallen, lass es mich über die [hier](/de/contact/) aufgeführten Kontaktmöglichkeiten wissen.
{: .notice--warning}

**ℹ️ Information:** Für zertifizierungsbezogene Materialien wirf einen Blick in den Abschnitt „📖 Verwandte Ressourcen“ oder die Inline-Verweise in meinen „🏅 Review“-Artikeln.
{: .notice--info}

🏭 Auf dieser Seite findest du eine kuratierte Auswahl von Links zu **Microsoft-Produkten und -Diensten**.

🔍 Die meisten dieser Links stammen aus Zertifizierungen, die ich studiert habe, Werkzeugen, die ich genutzt habe, oder Berufserfahrung, die ich im Lauf der Jahre gesammelt habe.

💡 Diese Liste wird sich weiterentwickeln, während ich neue Ressourcen erkunde und validiere — betrachte sie also als laufende Arbeit. Bleib dran!
...
- [Learn about Azure AI Video Indexer](https://learn.microsoft.com/en-us/azure/azure-video-indexer/)
...
### 🛠️ Entwicklung und Tools
- [.NET documentation](https://learn.microsoft.com/en-us/dotnet/)
- [GitHub + Microsoft integration](https://learn.microsoft.com/en-us/github/)
...
- [Microsoft 365 Groups and Microsoft Teams naming policy](https://learn.microsoft.com/en-us/microsoft-365/solutions/groups-naming-policy)
...
- [Microsoft 365 troubleshooting for admins and IT professionals](https://learn.microsoft.com/en-us/troubleshoot/microsoft-365-apps/)
- [Microsoft Service Health Status](https://status.cloud.microsoft/m365/referrer=serviceStatusRedirect)
- [Overview of update channels for Microsoft 365 Apps](https://learn.microsoft.com/en-us/microsoft-365-apps/updates/overview-update-channels)
...
- [What is Microsoft 365?](https://www.microsoft.com/en-us/microsoft-365)
...
- [Collaborate on files in Microsoft Teams](https://support.microsoft.com/en-US/office/collaborate-on-files-in-microsoft-teams-9b200289-dbac-4823-85bd-628a5c7bb0ae)
...
- [IT Admins - Private channels in Microsoft Teams](https://learn.microsoft.com/en-us/microsoftteams/private-channels)
...
- [Manage Microsoft 365 connectors and custom connectors](https://learn.microsoft.com/en-us/microsoftteams/m365-custom-connectors)
...
- [Microsoft Teams Phone](https://learn.microsoft.com/en-us/microsoftteams/teams-phone-overview)
- [Microsoft Teams troubleshooting](https://learn.microsoft.com/en-us/troubleshoot/microsoftteams/teams-welcome)
...
- [Plan for live events in Microsoft Teams](https://learn.microsoft.com/en-us/microsoftteams/teams-live-events/plan-for-teams-live-events)
- [Plan for Teams meetings](https://learn.microsoft.com/en-us/microsoftteams/plan-meetings)
- [Plan for Teams town halls](https://learn.microsoft.com/en-us/microsoftteams/plan-town-halls)
- [Plan for Teams webinars](https://learn.microsoft.com/en-us/microsoftteams/plan-webinars)
...
- [Send diagnostic log files from Microsoft Teams mobile app](https://support.microsoft.com/en-US/office/send-diagnostic-log-files-from-microsoft-teams-mobile-app-86dea1fe-ba14-456a-a7b9-b76c48011316)
- [Shared channels in Microsoft Teams](https://learn.microsoft.com/en-us/microsoftteams/shared-channels)
- [Team expiration and renewal in Microsoft Teams](https://learn.microsoft.com/en-us/microsoftteams/team-expiration-renewal)
- [Troubleshoot connectivity issues with the Microsoft Teams client](https://learn.microsoft.com/en-us/microsoftteams/connectivity-issues)
- [Troubleshoot in Microsoft Teams](https://support.microsoft.com/en-us/office/troubleshoot-in-microsoft-teams-6fa7c08a-6fd4-47a0-b275-90a5f60f1df9)
...
- [User presence in Teams](http://learn.microsoft.com/en-us/microsoftteams/presence-admins)
- [Version update history for the new and classic Microsoft Teams app](https://learn.microsoft.com/en-us/officeupdates/teams-app-versioning)
- [What are Microsoft Teams live events](https://learn.microsoft.com/en-us/microsoftteams/teams-live-events/what-are-teams-live-events)
...
- [Microsoft Power Virtual Agents documentation](https://learn.microsoft.com/en-us/power-virtual-agents/)
- [Power Apps and Microsoft Teams integration](https://learn.microsoft.com/en-us/power-apps/teams/overview)
- [Power BI documentation](https://learn.microsoft.com/en-us/power-bi/)
- [Power BI service description](https://learn.microsoft.com/en-us/office365/servicedescriptions/power-bi-service-description)
- [Power Platform Admin documentation](https://learn.microsoft.com/en-us/power-platform/admin/admin-documentation)
...
- [Overview of Microsoft Purview](https://learn.microsoft.com/en-us/microsoft-365/compliance/microsoft-purview-overview)
- [Overview of Microsoft Security](https://learn.microsoft.com/en-us/microsoft-365/security/)
- [Overview of Microsoft Sentinel](https://learn.microsoft.com/en-us/azure/sentinel/overview)
- [Security in Microsoft 365](https://learn.microsoft.com/en-us/microsoft-365/security/)
- [Security in Microsoft Entra ID](https://learn.microsoft.com/en-us/entra/identity/concept-security)
- [What is Microsoft Defender for Endpoint?](https://learn.microsoft.com/en-us/microsoft-365/security/defender-endpoint/what-is-microsoft-defender-for-endpoint)
- [What is Microsoft Defender for Identity?](https://learn.microsoft.com/en-us/microsoft-365/security/defender-for-identity/what-is-defender-for-identity)
- [What is Microsoft Defender for Office 365?](https://learn.microsoft.com/en-us/microsoft-365/security/defender-office-365/what-is-defender-for-office-365)
...
- [Windows Script Host (WSH)](https://en.wikipedia.org/wiki/Windows_Script_Host)
